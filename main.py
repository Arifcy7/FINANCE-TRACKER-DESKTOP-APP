...
Label(frameL1, text="Date:", font=("Bahnschrift Condensed", "15"), bg="#F5F5F5", fg="#333333").grid(row=1, column=0, sticky=W, padx=50, pady=10)
dateField = DateEntry(frameL1, width=20, background='#4CAF50', foreground='white', borderwidth=2)
...
Button(frameL3, text="Show Total Expense", font=("Bahnschrift Condensed", "13"), width=30, bg="#FFA07A", fg="#FFFFFF",
       relief=GROOVE, activebackground="#FF7F50", activeforeground="#FFFFFF", command=showTotalExpense).grid(row=5,
                                                                                                             column=0,
                                                                                                             sticky=W,
                                                                                                             padx=50,
                                                                                                             pady=10)
...
Button(frameL3, text="Show Monthly Expense", font=("Bahnschrift Condensed", "13"), width=30, bg="#FFA07A", fg="#FFFFFF",
       relief=GROOVE, activebackground="#FF7F50", activeforeground="#FFFFFF", command=showMonthlyExpense).grid(row=6,
                                                                                                              column=0,
                                                                                                              sticky=W,
                                                                                                              padx=50,
                                                                                                              pady=10)
...
Button(frameL3, text="Show Yearly Expense", font=("Bahnschrift Condensed", "13"), width=30, bg="#FFA07A", fg="#FFFFFF",
       relief=GROOVE, activebackground="#FF7F50", activeforeground="#FFFFFF", command=showYearlyExpense).grid(row=7,
                                                                                                             column=0,
                                                                                                             sticky=W,
                                                                                                             padx=50,
                                                                                                             pady=10)
...
Button(frameL3, text="Exit", font=("Bahnschrift Condensed", "13"), width=30, bg="#FFA07A", fg="#FFFFFF", relief=GROOVE,
       activebackground="#FF7F50", activeforeground="#FFFFFF", command=mainWindow.quit).grid(row=4,
                                                                                             column=0,
                                                                                             sticky=W,
                                                                                             padx=50,
                                                                                             pady=10)
